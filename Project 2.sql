...
SELECT "Higher Studies" Career_choice,(COUNT(college_a_hs.RollNo) /(college_a_hs.RollNo))*100 College_A_Percentage,(COUNT(college_b_hs.RollNo)/(college_b_hs.RollNo))*100 College_B_Percentage   FROM college_a_hs CROSS JOIN college_b_hs UNION 
SELECT "Self Empolyment" Career_choice,(COUNT(college_a_se.RollNo) /(college_a_se.RollNo))*100 College_A_Percentage,(COUNT(college_b_se.RollNo)/(college_b_se.RollNo))*100 College_B_Percentage   FROM college_a_se CROSS JOIN college_b_se UNION
SELECT "Service Job" Career_choice,(COUNT(college_a_sj.RollNo) /(college_a_sj.RollNo))*100 College_A_Percentage,(COUNT(college_b_sj.RollNo)/(college_b_sj.RollNo))*100 College_B_Percentage    FROM college_a_sj CROSS JOIN college_b_sj;
